...
class BaseController {
    ...
    protected function showHomeStudente($vd) {
        ...
        $vd->setTitolo("esAMMistudenteeee - gestione studente ");
    ...
    protected function showHomeAmministratore($vd) {
        ...
        $vd->setTitolo("home amministratore");
    ...
    protected function showHomeUtente($vd) {
        $user = UserFactory::instance()->cercaUtentePerId($_SESSION[self::user], $_SESSION[self::role]);if($user==null) echo "  NULL  ";
    ...
    protected function login($vd, $username, $password) {
        ...
        if (isset($user) && $user->esiste()) {echo "pobaaaaaaaaaaaaaaaaaaaaaaaaa";
            // utente autenticato
